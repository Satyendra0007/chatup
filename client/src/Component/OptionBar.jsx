...
export default function OptionBar({ deleteMessage, id, text, setText, setShowSeenBy, isGroup, setIsEditingMessage }) {
  ...
  return (
    <div className='flex gap-3 justify-end p-3 md:p-2 rounded-full bg-black/5 backdrop-blur-xs shadow-sm w-full '>
      ...
      <button onClick={handleOnEdit} className="edit p-2 bg-white text-green-800  rounded-full shadow-lg text-xl cursor-pointer hover:bg-gray-200 transition-all duration-300 "><BiMessageSquareEdit /></button>
